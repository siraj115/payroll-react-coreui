...
const EmployeeProvidentFundForm  = ()=>{
    return(
        <CContainer>
            <CRow>
                <CCol xs={12}>
                    <CCard className="mb-4">
                        <CCardBody>
                            <CForm
                                ...
                                <CCol md={3}>
                                    <CFormLabel htmlFor="overtimehrs">From(Yrs) <code color="danger">*</code></CFormLabel>
                                    <CFormInput type="number" id="overtimehrs" defaultValue="" required /> 
                                    <CFormFeedback valid>Looks good!</CFormFeedback>
                                </CCol>
                                <CCol md={3}>
                                    <CFormLabel htmlFor="overtimehrs">To(Yrs) <code color="danger">*</code></CFormLabel>
                                    <CFormInput type="number" id="overtimehrs" defaultValue="" required /> 
                                    <CFormFeedback valid>Looks good!</CFormFeedback>
                                </CCol>
...
export default React.memo(EmployeeProvidentFundForm)