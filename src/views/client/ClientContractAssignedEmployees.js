...
import ClientContractDetailTable from "./ClientContractDetailTable";
const ClientContractAssignedEmployees  = ({singleClientData})=>{
            ...
            <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CForm
                        ...
                        >
                        <CCol md={3}>
                            <CFormLabel htmlFor="advanceReasons">Reason1 <code color="danger">*</code></CFormLabel>
...
export default React.memo(ClientContractAssignedEmployees)